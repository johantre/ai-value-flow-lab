(function () {
  ...
  // (the cover, e.g. books/<slug>/cover.jpg) gets that image moved to the
  // top of the right sidebar, above Graph View — so it stays visible while
  // reading, independent of the Properties panel's collapsed state.
  ...
  function relocateCover() {
    ...
    if (!rightSidebar || !img) return;

    img.classList.add('book-cover');
    rightSidebar.insertBefore(img, rightSidebar.firstChild);
    firstP.remove();
  }
