...
- **[Crucial Conversations](../books/patterson-crucial-conversations-tools-for-talking-when-stakes-are-high.md)** — de toolset voor het gesprek zelf: veiligheid creëren ([[mutual-purpose|Mutual Purpose]] + Mutual Respect), het eigen perspectief inbrengen zonder te forceren ([[state-your-path|STATE]]), de ander laten spreken ([[ampp|AMPP]]). Motivationele interventie is de *keuze* om in te grijpen — Crucial Conversations is de *vaardigheid* om het te doen.
