...
Taking ownership of outcomes, not just tasks. Different from responsibility (being assigned something) — accountability is chosen. In probe design: someone must own each probe and its learning, regardless of outcome.
