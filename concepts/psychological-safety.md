...
The shared belief that the team is safe for interpersonal risk-taking. The single most important factor for high team performance (Google Project Aristotle). Without it: probes are not run honestly, failures are hidden, sensing signals are ignored.
