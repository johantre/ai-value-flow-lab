...
The internal pictures and assumptions we use to make sense of the world. Senge: mental models are often implicit and unchallenged. AI-first transformation requires surfacing and updating mental models about work, value, and human roles. The brutale analyse (Section 5) is a mental model challenge.
