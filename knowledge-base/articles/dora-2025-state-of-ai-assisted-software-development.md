...
Dit is directe empirische bevestiging van onze **centrale these**: *"AI introduceert geen dysfunctions uit het niets. Het versnelt, vergroot en verhult."* DORA onderbouwt daarmee ook het **meta-principe** in [AI Org Dysfunction Map](../../issues-in-org-w-ai/ai-org-dysfunction-map.md#het-meta-principe-ai-als-versterker-van-bestaande-dysfunctions) — letterlijk tot in de formulering ("amplifier... magnifies the strengths... and the dysfunctions").
