...
Dit is het scherpste cijfermatige bewijs dat we tot nu toe hebben voor een **dynamiek die nog geen eigen plek heeft** in de [AI Org Dysfunction Map](../../issues-in-org-w-ai/ai-org-dysfunction-map.md): de **verschuiving van de bottleneck** van creatie naar verificatie, zonder dat die verificatielast ergens georganiseerd is.
