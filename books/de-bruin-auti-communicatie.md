---
lang: nl
title: "Auti-communicatie: brug tussen mensen met en zonder autisme"
author: "Colette de Bruin"
year: 2012
status: unread
tags: [autisme, communicatie, opvoeding, gedrag]
source: goodreads
---

![cover](./de-bruin-auti-communicatie/cover.jpg)
...
- **8.2 In de taak zetten** — de sectietitel is duidelijk, maar de precieze uitwerking kon ik niet onafhankelijk verifiëren buiten de titel zelf.
...
- **8.4 Opgesplitst parkeren in de tijd** — vermoedelijk een verfijning van 8.3 voor situaties met meerdere losse onderdelen die elk een eigen "wanneer" nodig hebben; niet onafhankelijk geverifieerd buiten de titel.
...
- **9.4 Interne motivatie zoeken** — zoek eerst naar CASS's eigen intrinsieke motivatie. Die kan tekortschieten wanneer het doel te abstract of te ver weg is (het klassieke voorbeeld: "voor later" leren is voor een puber met ASS een abstract begrip zonder trekkracht). Schiet interne motivatie tekort, dan kan een concrete, aan het gewenste gedrag gekoppelde externe prikkel worden ingezet.
- **9.5 Win-winnen** — de sectietitel wijst op het zoeken van een oplossing waarin zowel de vraag van de omgeving als het belang van CASS worden gediend, in plaats van eenzijdige gehoorzaamheid te eisen; de precieze uitwerking in het boek kon ik niet onafhankelijk verifiëren buiten de titel.
